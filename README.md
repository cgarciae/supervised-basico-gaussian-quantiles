...
### Ranking
Ver [ranking](https://github.com/cgarciae/supervised-basico-gaussian-quantiles/blob/master/ranking.md).
...
```bash
git clone https://github.com/{username}/supervised-basico-gaussian-quantiles
cd supervised-basico-gaussian-quantiles
```
